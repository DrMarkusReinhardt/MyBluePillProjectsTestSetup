...
\newpage
\section{Project Software Setup (first sketch)}
...
\subsection{LCD control via I2C (second sketch)}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.85\linewidth]{Figures/Test_BluePill_I2C_LCD_HWSetup.jpeg}
	\caption{VSCode/PlatformIO IDE (second sketch)}
