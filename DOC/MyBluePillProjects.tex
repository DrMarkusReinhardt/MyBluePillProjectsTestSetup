...
The connections are done as follows (Table \ref{table:ConnectionSTLink1}):
\begin{table}[htbp]
\centering
\begin{tabular}{|c|c|c|}
	\hline
...
\begin{tabular}{|c|c|c|}
	...
	\hline
\end{tabular}
\caption{Connection Blue Pill to USB/Serial adapter (Setup 1)}
...
\section{Project 1 Software Setup (first sketch)}
...
\subsection{Project 2: LCD control via I2C (second sketch)}
...
\begin{figure}[htbp]
	...
	\caption{VSCode/PlatformIO IDE (second sketch)}
	\label{fig:IDESetup2}
\end{figure}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
	\end{tabular}
\caption{Connection "Blue Pill" to USB/Serial adapter (Setup 2)}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
	\end{tabular}
\caption{Connection "Blue Pill" to I2C adapter of the LCD (Setup 2)}
