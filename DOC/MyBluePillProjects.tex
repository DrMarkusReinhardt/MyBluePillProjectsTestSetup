...
The STM32 processor of the "Blue Pill" board has no EEPROM like AVR devices, but the flash memory can be reused to emulate EEPROM storage.
The project tested writing and retrieving standard and custom data types to the flash.
